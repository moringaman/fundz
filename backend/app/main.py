...
async def lifespan(app: FastAPI):
    ...
    _migrations = [
        ...
        # Columns added by Alembic that must be present on fresh deploys
        ("positions", "entry_indicators", "ALTER TABLE positions ADD COLUMN entry_indicators JSON"),
        ("positions", "entry_regime", "ALTER TABLE positions ADD COLUMN entry_regime VARCHAR(20)"),
        ("positions", "entry_regime_confidence", "ALTER TABLE positions ADD COLUMN entry_regime_confidence FLOAT"),
        ("trades", "entry_regime", "ALTER TABLE trades ADD COLUMN entry_regime VARCHAR(20)"),
        ("trades", "entry_regime_confidence", "ALTER TABLE trades ADD COLUMN entry_regime_confidence FLOAT"),
        ("accumulation_config", "dca_balance_pct", "ALTER TABLE accumulation_config ADD COLUMN dca_balance_pct FLOAT DEFAULT 0.0"),
        ("accumulation_config", "dca_next_at", "ALTER TABLE accumulation_config ADD COLUMN dca_next_at TIMESTAMP WITH TIME ZONE"),
        ("accumulation_config", "dca_count", "ALTER TABLE accumulation_config ADD COLUMN dca_count INTEGER DEFAULT 0"),
        ("accumulation_config", "va_target_growth_rate", "ALTER TABLE accumulation_config ADD COLUMN va_target_growth_rate FLOAT DEFAULT 1.0"),
        ("accumulation_config", "va_next_at", "ALTER TABLE accumulation_config ADD COLUMN va_next_at TIMESTAMP WITH TIME ZONE"),
        ("accumulation_config", "va_count", "ALTER TABLE accumulation_config ADD COLUMN va_count INTEGER DEFAULT 0"),
        ("accumulation_config", "dip_levels", "ALTER TABLE accumulation_config ADD COLUMN dip_levels JSON DEFAULT '[]'::json"),
        ("accumulation_config", "dip_count", "ALTER TABLE accumulation_config ADD COLUMN dip_count INTEGER DEFAULT 0"),
        ("accumulation_config", "scale_out_enabled", "ALTER TABLE accumulation_config ADD COLUMN scale_out_enabled BOOLEAN DEFAULT FALSE"),
        ("accumulation_config", "scale_out_target_pct", "ALTER TABLE accumulation_config ADD COLUMN scale_out_target_pct FLOAT DEFAULT 30.0"),
        ("accumulation_config", "scale_out_tranche_pct", "ALTER TABLE accumulation_config ADD COLUMN scale_out_tranche_pct FLOAT DEFAULT 10.0"),
        ("accumulation_config", "scale_out_max_transfers", "ALTER TABLE accumulation_config ADD COLUMN scale_out_max_transfers INTEGER DEFAULT 4"),
        ("accumulation_config", "scale_out_count", "ALTER TABLE accumulation_config ADD COLUMN scale_out_count INTEGER DEFAULT 0"),
        ("balances", "fund_type", "ALTER TABLE balances ADD COLUMN fund_type VARCHAR(20) DEFAULT 'trading'"),
